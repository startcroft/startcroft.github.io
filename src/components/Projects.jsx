    ...
    const projects = [
        {
            ...
            name: "Air Ticket",
            images: [
            {id:1, image: "../src/assets/air-ticket1.png"},
            {id:2, image: "../src/assets/air-ticket2.png"},
            {id:3, image: "../src/assets/air-ticket3.png"},
            ],
        ...
        },
        {
            ...
            name: "ShelfScape",
            images: [
                {id:1, image: "../src/assets/shelfScpe1.png"},
                {id:2, image: "../src/assets/shelfScape2.png"},
                {id:3, image: "../src/assets/shelfScape3.png"},
            ],
        ...
        },
        {
            ...
            name: "World Explorer",
            images: [
            {id:1, image: "../src/assets/world-explorer1.png"},
            {id:2, image: "../src/assets/world-explorer2.png"},
            ],
        ...
        <>
            <div className='projects'>
                <div className='projects__carrusel'>
                    <Slider {...settings} className='Slider'>
                        {projects.map((project) => (
                            <div key={project.id} className='projects__carrusel--card' onClick={() => {handleProject(project.id)}}> 
                                <div>
                                    <img src={project.images[0].image} alt="project" className='card__image' />
                                </div>
                ...
                </div>
                {
                    modalState &&
                    <div
                    className='projectDetails__container'
